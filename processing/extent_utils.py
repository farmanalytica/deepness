...
def calculate_extended_processing_extent(base_extent: QgsRectangle,
    ...
    # Validate rlayer_units_per_pixel to avoid division by zero / infinity later
    if not math.isfinite(rlayer_units_per_pixel) or rlayer_units_per_pixel <= 0:
        msg = f"Invalid rlayer_units_per_pixel: {rlayer_units_per_pixel}. Check resolution_m_per_px and layer CRS/resolution."
